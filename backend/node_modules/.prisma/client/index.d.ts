...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__AuditClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    user<T extends Audit$userArgs<ExtArgs> = {}>(args?: Subset<T, Audit$userArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow"> | null, null, ExtArgs>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface AuditFieldRefs {
    ...
    readonly status: FieldRef<"Audit", 'Int'>
    readonly responseTimeMs: FieldRef<"Audit", 'Int'>
    readonly title: FieldRef<"Audit", 'String'>
    readonly metaDescription: FieldRef<"Audit", 'String'>
    readonly h1Count: FieldRef<"Audit", 'Int'>
    readonly imagesMissingAlt: FieldRef<"Audit", 'Int'>
    readonly wordCount: FieldRef<"Audit", 'Int'>
    readonly score: FieldRef<"Audit", 'Int'>
    readonly grade: FieldRef<"Audit", 'String'>
  ...
  export type AuditWhereInput = {
    ...
    status?: IntFilter<"Audit"> | number
    responseTimeMs?: IntFilter<"Audit"> | number
    title?: StringNullableFilter<"Audit"> | string | null
    metaDescription?: StringNullableFilter<"Audit"> | string | null
    h1Count?: IntFilter<"Audit"> | number
    imagesMissingAlt?: IntFilter<"Audit"> | number
    wordCount?: IntFilter<"Audit"> | number
    score?: IntFilter<"Audit"> | number
    grade?: StringFilter<"Audit"> | string
  ...
  export type AuditScalarWhereWithAggregatesInput = {
    ...
    status?: IntWithAggregatesFilter<"Audit"> | number
    responseTimeMs?: IntWithAggregatesFilter<"Audit"> | number
    title?: StringNullableWithAggregatesFilter<"Audit"> | string | null
    metaDescription?: StringNullableWithAggregatesFilter<"Audit"> | string | null
    h1Count?: IntWithAggregatesFilter<"Audit"> | number
    imagesMissingAlt?: IntWithAggregatesFilter<"Audit"> | number
    wordCount?: IntWithAggregatesFilter<"Audit"> | number
    score?: IntWithAggregatesFilter<"Audit"> | number
    grade?: StringWithAggregatesFilter<"Audit"> | string
  ...
  export type AuditUpdateInput = {
    ...
    h1Count?: IntFieldUpdateOperationsInput | number
    imagesMissingAlt?: IntFieldUpdateOperationsInput | number
